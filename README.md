...
1. Korisnik se prijavljuje hashom (demo hash: `demo`)
2. Na ekranu **Upis** može birati filter i upisati se na predmete/grupe
3. Na ekranu **Kvizovi** vidi listu, pretražuje i pristupa kvizovima
4. Klikom na kviz otvara se **KvizDetalji** — tu se pokreće kviz, odgovara na pitanja uz progress bar, i na kraju prikazuje rezultat
5. Na **Profilu** se prati statistika i po potrebi vrši odjava
